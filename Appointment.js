document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (e) {
    ...
    if (contact === "")
      showError("contactError", "Please enter a contact number.");
    if (email === "") {
    ...
    if (requestFor === "")
      showError("requestError", "Please select a request type.");
    if (speciality === "")
      showError("specialityError", "Please select a speciality.");
